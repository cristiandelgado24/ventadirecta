        ...
        <div id="container" class="col-md-10 rounded-2 bg-white mx-auto">
            ...
            <div id="transactionResultBody" class="row justify-content-center">
                ...
                <div style="width:18em; display:none;" class="px-0 mx-1" id="reintentarTransaccionButtonDiv">
                    <a href="<?php echo $_ENV['FRONTEND_SERVER_URL']?>" class="btn mt-4 mb-4 w-100 text-center p-0" style="background-color: #8fca00; box-shadow: 1px 0.5px 1px 1px rgba(32,32,32,0.3);" id="reintentarTransaccionButton">
                        <div class="row py-1 d-flex justify-content-center align-items-center">
...
<?php //include '../views/modules/transactionVoucher.module.php';?>
<?php include '../views/modules/footer.module.php';?>
</div>
<script type="text/javascript">
    //$('#spinner').show();
    $(document).ready(function(){
        let serverLocation = '<?php echo $_ENV['BACKEND_SERVER_URL']?>';
        let referencia = '';
        ...
        console.log('<?php echo $_GET['reference']?>');
        ...
        $.ajax({
            ...
            success: function (r) {
                ...
                $.ajax({
                    ...
                    data: JSON.stringify({
                        'referencia': '<?php echo $_GET['reference']?>',
                    ...
                    success: function(r){
                        ...
                        $.ajax({
                            url: "<?php echo $_ENV['PLACETOPAY_URL']?>/api/session/"+requestID,
                            method: "POST",
                            data: JSON.stringify({
                                auth:{
                                "tranKey": trankey,
                                ...
                                $.ajax({
                                    ...
                                    success: function(r){
                                        ...
                                        if (estado == 'APPROVED' || estado == 'REJECTED') {
                                            ...
                                            $.ajax({
                                                url: "<?php echo $_ENV['SERVICIOS_CUN_API']?>/respuestaPagos",
                                                method: "POST",
                                                headers: {
                                                    "Authorization": "Bearer " + cunToken
                                                },
