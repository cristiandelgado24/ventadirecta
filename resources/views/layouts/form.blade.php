...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        serverLocation = '{{getenv('BACKEND_SERVER_URL')}}';
    ...
    function registrar() {
        ...
        if(!errorsCount && $('#acceptConditionsBox').is(':checked')){
            ...
            let route = '{{getenv('BACKEND_SERVER_URL')}}';
            ...
            $.ajax({
                ...
                success: function (r) {
                    $.ajax({
                        url: '{{getenv('BACKEND_SERVER_URL')}}/LastTransactionByDocument.php',
                        method: 'POST',
                        data: {
                            document: documento
                        },
                                    ...
                                    success: function (r) {
                                        ...
                                        $.ajax({
                                            ...
                                            success: function (r) {
                                                ...
                                                $.ajax({
                                                    url: "{{getenv('PLACETOPAY_URL')}}/api/session/" + r['requestId'],
                                                    method: "POST",
                                                    data: JSON.stringify({
                                                        auth: {
                                                            "tranKey": trankey,
                ...
                if (r['status'] == true) {
                    if (r['output'].includes('Salida: ERROR')) {
                        ...
                        jsonPP = {
                            ...
                            "returnUrl": "{{getenv('FRONTEND_SERVER_URL')}}/views/transactionResult.php?reference=" + reference,
                        ...
                        $.ajax({
                            url: '{{getenv('PLACETOPAY_URL')}}/api/session',
                            type: 'POST',
                            data: jsonPP,
                            success: function (r) {
                                ...
                                $.ajax({
                                    ...
                                    success: function (r) {
                                        ...
                                        let dataTransaccionPagos = {
                                            ...
                                            "unOrigen": "{{getenv('ENTORNO_PLACE_TO_PAY')}}",
                                            "unCodigoBanco": null,
                                            "unNombreBanco": null,
                                            "unTipoCuenta": null,
                                            "unNumeroCuenta": null
                                        ...
                                        $.ajax({
                                            url: "{{getenv('SERVICIOS_CUN_API')}}/transaccionPagos",
                                            method: "POST",
                                            headers: {
                                                'Authorization': 'Bearer ' + cunToken
                                            },
                                            ...
                                            success: function (r) {
                                                ...
                                                if (r['code'] == 200) {
                                                    ...
                                                    P.on('response', (r) => {
                                                        ...
                                                        location.href = 'http://127.0.0.1:8000/transaction-result/' + r['reference'];
                                                    });
                                                } else {
                                                    $('#contenedor-spinner').css('display', 'none');
                                                    Swal.fire({
